...
func (c *Client) List(ctx context.Context, request *devices.UnmanagedListRequest) (*seamapigo.UnmanagedListResponse, error) {
...
func (c *Client) Update(ctx context.Context, request *devices.UnmanagedUpdateRequest) (*seamapigo.UnmanagedUpdateResponse, error) {
	baseURL := "https://connect.getseam.com"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}

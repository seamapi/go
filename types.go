...
const (
	DeviceDeviceTypeAkuvoxLock             DeviceDeviceType = "akuvox_lock"
	DeviceDeviceTypeAugustLock             DeviceDeviceType = "august_lock"
	DeviceDeviceTypeBrivoAccessPoint       DeviceDeviceType = "brivo_access_point"
	DeviceDeviceTypeButterflymxPanel       DeviceDeviceType = "butterflymx_panel"
	DeviceDeviceTypeAvigilonAltaEntry      DeviceDeviceType = "avigilon_alta_entry"
	DeviceDeviceTypeDoorkingLock           DeviceDeviceType = "doorking_lock"
	DeviceDeviceTypeGenieDoor              DeviceDeviceType = "genie_door"
	DeviceDeviceTypeIglooLock              DeviceDeviceType = "igloo_lock"
	DeviceDeviceTypeLinearLock             DeviceDeviceType = "linear_lock"
	DeviceDeviceTypeLocklyLock             DeviceDeviceType = "lockly_lock"
	DeviceDeviceTypeKwiksetLock            DeviceDeviceType = "kwikset_lock"
	DeviceDeviceTypeNukiLock               DeviceDeviceType = "nuki_lock"
	DeviceDeviceTypeSaltoLock              DeviceDeviceType = "salto_lock"
	DeviceDeviceTypeSchlageLock            DeviceDeviceType = "schlage_lock"
	DeviceDeviceTypeSeamRelay              DeviceDeviceType = "seam_relay"
	DeviceDeviceTypeSmartthingsLock        DeviceDeviceType = "smartthings_lock"
	DeviceDeviceTypeWyzeLock               DeviceDeviceType = "wyze_lock"
	DeviceDeviceTypeYaleLock               DeviceDeviceType = "yale_lock"
	DeviceDeviceTypeTwoNIntercom           DeviceDeviceType = "two_n_intercom"
	DeviceDeviceTypeControlbywebDevice     DeviceDeviceType = "controlbyweb_device"
	DeviceDeviceTypeTtlockLock             DeviceDeviceType = "ttlock_lock"
	DeviceDeviceTypeIgloohomeLock          DeviceDeviceType = "igloohome_lock"
	DeviceDeviceTypeHubitatLock            DeviceDeviceType = "hubitat_lock"
	DeviceDeviceTypeFourSuitesDoor         DeviceDeviceType = "four_suites_door"
	DeviceDeviceTypeDormakabaOracodeDoor   DeviceDeviceType = "dormakaba_oracode_door"
	DeviceDeviceTypeNoiseawareActivityZone DeviceDeviceType = "noiseaware_activity_zone"
	DeviceDeviceTypeMinutSensor            DeviceDeviceType = "minut_sensor"
	DeviceDeviceTypeEcobeeThermostat       DeviceDeviceType = "ecobee_thermostat"
	DeviceDeviceTypeNestThermostat         DeviceDeviceType = "nest_thermostat"
	DeviceDeviceTypeIosPhone               DeviceDeviceType = "ios_phone"
	DeviceDeviceTypeAndroidPhone           DeviceDeviceType = "android_phone"
)

func NewDeviceDeviceTypeFromString(s string) (DeviceDeviceType, error) {
	switch s {
	case "akuvox_lock":
		return DeviceDeviceTypeAkuvoxLock, nil
	case "august_lock":
		return DeviceDeviceTypeAugustLock, nil
	case "brivo_access_point":
		return DeviceDeviceTypeBrivoAccessPoint, nil
	case "butterflymx_panel":
		return DeviceDeviceTypeButterflymxPanel, nil
	case "avigilon_alta_entry":
		return DeviceDeviceTypeAvigilonAltaEntry, nil
	case "doorking_lock":
		return DeviceDeviceTypeDoorkingLock, nil
	case "genie_door":
		return DeviceDeviceTypeGenieDoor, nil
	case "igloo_lock":
		return DeviceDeviceTypeIglooLock, nil
	case "linear_lock":
		return DeviceDeviceTypeLinearLock, nil
	case "lockly_lock":
		return DeviceDeviceTypeLocklyLock, nil
	case "kwikset_lock":
		return DeviceDeviceTypeKwiksetLock, nil
	case "nuki_lock":
		return DeviceDeviceTypeNukiLock, nil
	case "salto_lock":
		return DeviceDeviceTypeSaltoLock, nil
	case "schlage_lock":
		return DeviceDeviceTypeSchlageLock, nil
	case "seam_relay":
		return DeviceDeviceTypeSeamRelay, nil
	case "smartthings_lock":
		return DeviceDeviceTypeSmartthingsLock, nil
	case "wyze_lock":
		return DeviceDeviceTypeWyzeLock, nil
	case "yale_lock":
		return DeviceDeviceTypeYaleLock, nil
	case "two_n_intercom":
		return DeviceDeviceTypeTwoNIntercom, nil
	case "controlbyweb_device":
		return DeviceDeviceTypeControlbywebDevice, nil
	case "ttlock_lock":
		return DeviceDeviceTypeTtlockLock, nil
	case "igloohome_lock":
		return DeviceDeviceTypeIgloohomeLock, nil
	case "hubitat_lock":
		return DeviceDeviceTypeHubitatLock, nil
	case "four_suites_door":
		return DeviceDeviceTypeFourSuitesDoor, nil
	case "dormakaba_oracode_door":
		return DeviceDeviceTypeDormakabaOracodeDoor, nil
	case "noiseaware_activity_zone":
		return DeviceDeviceTypeNoiseawareActivityZone, nil
	case "minut_sensor":
		return DeviceDeviceTypeMinutSensor, nil
	case "ecobee_thermostat":
		return DeviceDeviceTypeEcobeeThermostat, nil
	case "nest_thermostat":
		return DeviceDeviceTypeNestThermostat, nil
	case "ios_phone":
		return DeviceDeviceTypeIosPhone, nil
	case "android_phone":
		return DeviceDeviceTypeAndroidPhone, nil
	}
	var t DeviceDeviceType
	return "", fmt.Errorf("%s is not a valid %T", s, t)
}

func (d DeviceDeviceType) Ptr() *DeviceDeviceType {
	return &d
}
...
// Type of the device.
type UnmanagedDeviceDeviceType string

const (
	UnmanagedDeviceDeviceTypeAkuvoxLock             UnmanagedDeviceDeviceType = "akuvox_lock"
	UnmanagedDeviceDeviceTypeAugustLock             UnmanagedDeviceDeviceType = "august_lock"
	UnmanagedDeviceDeviceTypeBrivoAccessPoint       UnmanagedDeviceDeviceType = "brivo_access_point"
	UnmanagedDeviceDeviceTypeButterflymxPanel       UnmanagedDeviceDeviceType = "butterflymx_panel"
	UnmanagedDeviceDeviceTypeAvigilonAltaEntry      UnmanagedDeviceDeviceType = "avigilon_alta_entry"
	UnmanagedDeviceDeviceTypeDoorkingLock           UnmanagedDeviceDeviceType = "doorking_lock"
	UnmanagedDeviceDeviceTypeGenieDoor              UnmanagedDeviceDeviceType = "genie_door"
	UnmanagedDeviceDeviceTypeIglooLock              UnmanagedDeviceDeviceType = "igloo_lock"
	UnmanagedDeviceDeviceTypeLinearLock             UnmanagedDeviceDeviceType = "linear_lock"
	UnmanagedDeviceDeviceTypeLocklyLock             UnmanagedDeviceDeviceType = "lockly_lock"
	UnmanagedDeviceDeviceTypeKwiksetLock            UnmanagedDeviceDeviceType = "kwikset_lock"
	UnmanagedDeviceDeviceTypeNukiLock               UnmanagedDeviceDeviceType = "nuki_lock"
	UnmanagedDeviceDeviceTypeSaltoLock              UnmanagedDeviceDeviceType = "salto_lock"
	UnmanagedDeviceDeviceTypeSchlageLock            UnmanagedDeviceDeviceType = "schlage_lock"
	UnmanagedDeviceDeviceTypeSeamRelay              UnmanagedDeviceDeviceType = "seam_relay"
	UnmanagedDeviceDeviceTypeSmartthingsLock        UnmanagedDeviceDeviceType = "smartthings_lock"
	UnmanagedDeviceDeviceTypeWyzeLock               UnmanagedDeviceDeviceType = "wyze_lock"
	UnmanagedDeviceDeviceTypeYaleLock               UnmanagedDeviceDeviceType = "yale_lock"
	UnmanagedDeviceDeviceTypeTwoNIntercom           UnmanagedDeviceDeviceType = "two_n_intercom"
	UnmanagedDeviceDeviceTypeControlbywebDevice     UnmanagedDeviceDeviceType = "controlbyweb_device"
	UnmanagedDeviceDeviceTypeTtlockLock             UnmanagedDeviceDeviceType = "ttlock_lock"
	UnmanagedDeviceDeviceTypeIgloohomeLock          UnmanagedDeviceDeviceType = "igloohome_lock"
	UnmanagedDeviceDeviceTypeHubitatLock            UnmanagedDeviceDeviceType = "hubitat_lock"
	UnmanagedDeviceDeviceTypeFourSuitesDoor         UnmanagedDeviceDeviceType = "four_suites_door"
	UnmanagedDeviceDeviceTypeDormakabaOracodeDoor   UnmanagedDeviceDeviceType = "dormakaba_oracode_door"
	UnmanagedDeviceDeviceTypeNoiseawareActivityZone UnmanagedDeviceDeviceType = "noiseaware_activity_zone"
	UnmanagedDeviceDeviceTypeMinutSensor            UnmanagedDeviceDeviceType = "minut_sensor"
	UnmanagedDeviceDeviceTypeEcobeeThermostat       UnmanagedDeviceDeviceType = "ecobee_thermostat"
	UnmanagedDeviceDeviceTypeNestThermostat         UnmanagedDeviceDeviceType = "nest_thermostat"
	UnmanagedDeviceDeviceTypeIosPhone               UnmanagedDeviceDeviceType = "ios_phone"
	UnmanagedDeviceDeviceTypeAndroidPhone           UnmanagedDeviceDeviceType = "android_phone"
)

func NewUnmanagedDeviceDeviceTypeFromString(s string) (UnmanagedDeviceDeviceType, error) {
	switch s {
	case "akuvox_lock":
		return UnmanagedDeviceDeviceTypeAkuvoxLock, nil
	case "august_lock":
		return UnmanagedDeviceDeviceTypeAugustLock, nil
	case "brivo_access_point":
		return UnmanagedDeviceDeviceTypeBrivoAccessPoint, nil
	case "butterflymx_panel":
		return UnmanagedDeviceDeviceTypeButterflymxPanel, nil
	case "avigilon_alta_entry":
		return UnmanagedDeviceDeviceTypeAvigilonAltaEntry, nil
	case "doorking_lock":
		return UnmanagedDeviceDeviceTypeDoorkingLock, nil
	case "genie_door":
		return UnmanagedDeviceDeviceTypeGenieDoor, nil
	case "igloo_lock":
		return UnmanagedDeviceDeviceTypeIglooLock, nil
	case "linear_lock":
		return UnmanagedDeviceDeviceTypeLinearLock, nil
	case "lockly_lock":
		return UnmanagedDeviceDeviceTypeLocklyLock, nil
	case "kwikset_lock":
		return UnmanagedDeviceDeviceTypeKwiksetLock, nil
	case "nuki_lock":
		return UnmanagedDeviceDeviceTypeNukiLock, nil
	case "salto_lock":
		return UnmanagedDeviceDeviceTypeSaltoLock, nil
	case "schlage_lock":
		return UnmanagedDeviceDeviceTypeSchlageLock, nil
	case "seam_relay":
		return UnmanagedDeviceDeviceTypeSeamRelay, nil
	case "smartthings_lock":
		return UnmanagedDeviceDeviceTypeSmartthingsLock, nil
	case "wyze_lock":
		return UnmanagedDeviceDeviceTypeWyzeLock, nil
	case "yale_lock":
		return UnmanagedDeviceDeviceTypeYaleLock, nil
	case "two_n_intercom":
		return UnmanagedDeviceDeviceTypeTwoNIntercom, nil
	case "controlbyweb_device":
		return UnmanagedDeviceDeviceTypeControlbywebDevice, nil
	case "ttlock_lock":
		return UnmanagedDeviceDeviceTypeTtlockLock, nil
	case "igloohome_lock":
		return UnmanagedDeviceDeviceTypeIgloohomeLock, nil
	case "hubitat_lock":
		return UnmanagedDeviceDeviceTypeHubitatLock, nil
	case "four_suites_door":
		return UnmanagedDeviceDeviceTypeFourSuitesDoor, nil
	case "dormakaba_oracode_door":
		return UnmanagedDeviceDeviceTypeDormakabaOracodeDoor, nil
	case "noiseaware_activity_zone":
		return UnmanagedDeviceDeviceTypeNoiseawareActivityZone, nil
	case "minut_sensor":
		return UnmanagedDeviceDeviceTypeMinutSensor, nil
	case "ecobee_thermostat":
		return UnmanagedDeviceDeviceTypeEcobeeThermostat, nil
	case "nest_thermostat":
		return UnmanagedDeviceDeviceTypeNestThermostat, nil
	case "ios_phone":
		return UnmanagedDeviceDeviceTypeIosPhone, nil
	case "android_phone":
		return UnmanagedDeviceDeviceTypeAndroidPhone, nil
	}
	var t UnmanagedDeviceDeviceType
	return "", fmt.Errorf("%s is not a valid %T", s, t)
}

func (u UnmanagedDeviceDeviceType) Ptr() *UnmanagedDeviceDeviceType {
	return &u
}

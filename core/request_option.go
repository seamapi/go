...
func (r *RequestOptions) ToHeader() http.Header {
	...
	header.Set("client-session-token", fmt.Sprintf("%v", r.ClientSessionToken))
	return header
}
...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Fern-SDK-Version", "v0.0.17")
	return headers
}
...
type SeamWorkspaceOption struct {
	SeamWorkspace string
}

func (s *SeamWorkspaceOption) applyRequestOptions(opts *RequestOptions) {
	opts.SeamWorkspace = s.SeamWorkspace
}

// SeamClientSessionTokenOption implements the RequestOption interface.
type SeamClientSessionTokenOption struct {
	SeamClientSessionToken string
}

func (s *SeamClientSessionTokenOption) applyRequestOptions(opts *RequestOptions) {
	opts.SeamClientSessionToken = s.SeamClientSessionToken
}

// ClientSessionTokenOption implements the RequestOption interface.
type ClientSessionTokenOption struct {
	ClientSessionToken string
}

func (c *ClientSessionTokenOption) applyRequestOptions(opts *RequestOptions) {
	opts.ClientSessionToken = c.ClientSessionToken
}
